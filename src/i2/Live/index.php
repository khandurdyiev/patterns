...
namespace Se\Patterns\i2\Live;

use Se\Patterns\i2\Live\Model\User;
use Se\Patterns\i2\Live\Service\FirstPurchaseBonusCalculator;
use Se\Patterns\i2\Live\Service\ReferralBonusCalculator;
use Se\Patterns\i2\Live\Service\WelcomeBonusCalculator;
